...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 4. Evento de SUBMIT (gatilho após validação de campos obrigatórios)
    filtroForm.addEventListener('submit', (event) => {
        ...
        if (tiposSelecionados.length === 0) {
            alert('Por favor, selecione pelo menos um "Tipo" de serviço ou marque "Todos".');
            return;
        }
